  ...
  describe '#valid?' do
    ...
    context 'formato' do
      it 'falso quando formato do código é incorreto' do
        ...
        # Assert
        invalid_models.each { |model| expect(model).not_to be_valid }
    ...
    context 'valor' do
      it 'falso quando peso <= 0' do
        ...
        acme = Supplier.create!(brand_name: 'ACME', corporate_name: 'ACME Ltda.',
                                registration_number: 1_234_567_890_123, address: '', city: '', state: '', cep: '',
                                email: 'contato@acme.com', phone: '')
        notebook = ProductModel.new(name: 'Notebook', weight: 0, height: 15, width: 25, depth: 10,
                                    code: 'NOTE-MARCA-123456789', supplier: acme)
        tablet = ProductModel.new(name: 'Tablet', weight: -1, height: 10, width: 8, depth: 1,
                                  code: 'NOTE-MARCA-123456789', supplier: acme)
      ...
      it 'falso quando altura <= 0' do
        ...
        acme = Supplier.create!(brand_name: 'ACME', corporate_name: 'ACME Ltda.',
                                registration_number: 1_234_567_890_123, address: '', city: '', state: '', cep: '',
                                email: 'contato@acme.com', phone: '')
        notebook = ProductModel.new(name: 'Notebook', weight: 2_000, height: 0, width: 25, depth: 10,
                                    code: 'NOTE-MARCA-123456789', supplier: acme)
        tablet = ProductModel.new(name: 'Tablet', weight: 500, height: -1, width: 8, depth: 1,
                                  code: 'NOTE-MARCA-123456789', supplier: acme)
      ...
      it 'falso quando largura <= 0' do
        ...
        acme = Supplier.create!(brand_name: 'ACME', corporate_name: 'ACME Ltda.',
                                registration_number: 1_234_567_890_123, address: '', city: '', state: '', cep: '',
                                email: 'contato@acme.com', phone: '')
        notebook = ProductModel.new(name: 'Notebook', weight: 2_000, height: 15, width: 0, depth: 10,
                                    code: 'NOTE-MARCA-123456789', supplier: acme)
        tablet = ProductModel.new(name: 'Tablet', weight: 500, height: 10, width: -1, depth: 1,
                                  code: 'NOTE-MARCA-123456789', supplier: acme)
      ...
      it 'falso quando profundidade <= 0' do
        ...
        acme = Supplier.create!(brand_name: 'ACME', corporate_name: 'ACME Ltda.',
                                registration_number: 1_234_567_890_123, address: '', city: '', state: '', cep: '',
                                email: 'contato@acme.com', phone: '')
        notebook = ProductModel.new(name: 'Notebook', weight: 2_000, height: 15, width: 25, depth: 0,
                                    code: 'NOTE-MARCA-123456789', supplier: acme)
        tablet = ProductModel.new(name: 'Tablet', weight: 500, height: 10, width: 8, depth: -1,
                                  code: 'NOTE-MARCA-123456789', supplier: acme)
